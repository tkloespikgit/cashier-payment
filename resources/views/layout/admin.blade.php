...
<body>
<div id="wrapper">
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0;background: #303b4d">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h4 class="page-header">
                    <a href="{{request()->getRequestUri()}}" style="color: #303b4d;text-decoration: underline;">@yield('page-name',request()->getRequestUri())</a>
                </h4>
            </div>
